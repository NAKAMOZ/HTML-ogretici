        ...
        <div class="ort-pad">
            ...
            <div class="baslik grey-back golge bd-rad" style="width: 94%;">
                ...
                <div class="baslik dark-back bd-red" style="clear: both;width: 95%;text-align: left;color: white;">
                    ...
                    <span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>abbr <span class="nitelikrenk" style="color:red"> title</span><span class="etiketrenk" style="color:mediumblue">="Kısaltma Açıklaması"</span><span class="etiketrenk" style="color:mediumblue">&gt;</span></span> Kısaltma<span class="etiketisimrenk" style="color:brown"> <span class="etiketrenk" style="color:mediumblue">&lt;</span>/abbr<span class="etiketrenk" style="color:mediumblue">&gt;</span></span><br><br>
            ...
            <br>
            <p class="mtn">
                &lt;abbr&gt; etiketi sayfanızda WWW, HTML, HTTP gibi uzun sözcüklerin kisaltması olarak veya kısaltmasını temsil etmek için kullanılır. Bazı tarayıcılarda &lt;abbr&gt; etiketi arasında yazılan sözük/sözcükler altı çizili olarak görüntülenir.
            </p>
            <p class="mtn">
                Bu etiket "title" özelliği ile isteğe bağlı şekilde kullanılabilir ve fare imleci &lt;abbr&gt; etiketi arasında yazılan içeriğin üzerinde geldiği zaman, özellik değeri açılır
            </p>
            <div class="ust-bsl">Örnek</div>
            <p class="mtn">
                Fare ile yazının üstüne gelin
            </p>
            <p class="mtn">
                <abbr title="Kısaltma Açıklaması">Örnek &lt;abbr&gt; etiketi</abbr>
            </p>
        </div>
    </div>
    <div class="bol-b" style="margin-top:2%;width: 86%;float:right">
