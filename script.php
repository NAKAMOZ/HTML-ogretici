        ...
        <div class="ort-pad">
            ...
            <div class="baslik grey-back golge bd-rad" style="width: 94%;">
                ...
                <div class="baslik dark-back bd-red" style="clear: both;width: 95%;text-align: left;color: white;">
                    ...
                    <span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>script<span class="etiketrenk" style="color:mediumblue">&gt;</span></span><br />
                    &nbsp;&nbsp;&nbsp;Bir Javascript Kodu<br />
                    <span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>/script<span class="etiketrenk" style="color:mediumblue">&gt;</span></span><br><br>
            ...
            <br />
            <div class="mtn">
                Örnek Javascript Kodunu Çalıştırmak İçin Tıklayınız:<br /><br />
                <button onclick="myFunction()" class="buton0">Deneme</button>

                <script>
                    function myFunction() {
                        alert("Örnek Bir Javascript Kodu");
                    }
                </script>
            </div>
        </div>
