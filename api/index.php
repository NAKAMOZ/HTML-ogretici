...
<body>
    ...
    <div class="orta">
        <div class="bol-w">
            <div class="baslik fl-l">
                <h1 style="font-size: 60px;">HTML</h1>
                <h2>Web Sayfaları Oluşturmak İçin Kullanılan Dildir</h2>
            </div>
            <div class="baslik fl-l">
                <div class="baslik grey-back golge bd-rad" style="width: 90%;">
                    <h3 style="float: left;">Bir HTML Örneği:</h3>
        ...
        <div class="bol-g">
            <div class="baslik fl-r" style="padding-top: 8%;">
                <h1 style="font-size: 60px;">ETİKETLER</h1>
                <h2>Çok Çeşitli Etiketlere Sahip Bir İşaretleme Dilidir</h2>
            </div>
            <div class="baslik fl-r">
                <div class="baslik grey-back golge bd-rad" style="width: 90%;">
                    <h3 style="float: left;">Bir HTML Örneği:</h3>
                    <div class="baslik dark-back bd-red" style="clear: both;width: 95%;text-align: left;color: white;">
                        <span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>!DOCTYPE<span class="nitelikrenk" style="color:red"> html</span><span class="etiketrenk" style="color:mediumblue">&gt;</span></span><br>
