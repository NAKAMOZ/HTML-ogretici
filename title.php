...
<body>
    ...
    <div class="orta">
        <div class="ort-pad">
            ...
            <br>
            <p class="mtn">
                &lt;title&gt; etiketi, HTML belgesi için başlık tanımlar..
            </p>
            <div class="duy" style="padding-top:0px;">
                <span style="color:#f05454;font-size:200%;position:relative;top:9px;">!</span> Her zaman yazdığınız sayfalarda &lt;title&gt; kodunu kullanınız.
            </div>
        </div>
    </div>
    </div>
