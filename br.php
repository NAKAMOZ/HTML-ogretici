        ...
        <div class="ort-pad">
            ...
            <div class="baslik grey-back golge bd-rad" style="width: 94%;">
                ...
                <div class="baslik dark-back bd-red" style="clear: both;width: 95%;text-align: left;color: white;">
                    ...
                    <span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>h1<span class="etiketrenk" style="color:mediumblue">&gt;</span></span>Eğer çizgi kullanmıyorsanız<span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>br/<span class="etiketrenk" style="color:mediumblue">&gt;</span></span>bu paragrafta<span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>br/<span class="etiketrenk" style="color:mediumblue">&gt;</span></span>bu etiketi kullanın.<span class="etiketisimrenk" style="color:brown"><span class="etiketrenk" style="color:mediumblue">&lt;</span>/p<span class="etiketrenk" style="color:mediumblue">&gt;</span></span><br><br>
            ...
            <br>
            <p class="mtn">
                HTML &lt;br&gt; etiketi temel olarak paragrafı kesmek için kullanılır. Örneğin adreslerde veya çizgi ile satır bölünmesine ihtiyaç duyulan yerlerde kullanılabilir. Boş bir etikettir, Bitiş etiketine ihtiyaç duymaz.
            </p>
            <div class="duy" style="padding-top:0;">
                <span style="color:#f05454;font-size:200%;position:relative;top:9px;">!</span> HTML br etiketi iki şekilde kullanılabilir: &lt;br&gt; veya &lt;br/&gt; etiketleri HTML veya XHTML’de desteklenir. Ancak yine de &lt;br/&gt; kullanılması önerilir.
            </div>
            <div class="ust-bsl">Örnek</div>
            <p>Eğer çizgi kullanmıyorsanız<br>bu paragrafta<br>Bu etiketi kullanın.</p>
        </div>
    </div>
    <div class="bol-b" style="float:right;width: 86%;">
