...
<body>
    ...
    <div class="orta">
        <div class="ort-pad">
            ...
            <br>
            <p class="mtn">
                &lt;!DOCTYPE&gt; bir etiket değildir, sayfanın oluşturulduğu dilin sürümünü tarayıcıya söylemeye yarıyan bir koddur. Açılımı Document Type Definition'dır (Döküman Türü Tanımlaması). Bu kod yazılan sayfanın tarayıcılarda düzgün çalışması için biçimlendirme dilinin kurallarını belirler.
            </p>
            <div class="duy" style="padding-top:0px;">
                <span style="color:#f05454;font-size:200%;position:relative;top:9px;">!</span> Her zaman yazdığınız sayfalarda &lt;!DOCTYPE&gt; kodunu kullanınız. Bu kod tarayıcıların sayfanızın doğru görünmesini sağlıyacaktır.
            </div>
        </div>
    </div>
    </div>
    <div class="bol-b" style="float:right;width: 86%;margin-top:4.9%;">
